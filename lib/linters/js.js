...
JSLinter = (function() {
  ...
  JSLinter.prototype._lint = function(config, options, next) {
    var defaultOptions, hasFiles, i, rules, _ref,
      _this = this;
    hasFiles = ((_ref = options.files) != null ? _ref.length : void 0) > 0;
    if (!hasFiles) {
      return next();
    }
    defaultOptions = this.defaultOptions[options.extension] || {};
    rules = _.extend({}, this.defaultOptions[options.extension], this.options);
    i = 0;
